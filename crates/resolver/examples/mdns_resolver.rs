...
static GLOBAL_DNS_RESOLVER: Lazy<TokioResolver> = Lazy::new(|| {
    ...
    thread::spawn(move || {
        ...
        let mdns_ipv4 = *hickory_proto::multicast::MDNS_IPV4;
        let mdns_ipv6 = *hickory_proto::multicast::MDNS_IPV6;
        ...
        let resolver = TokioResolver::builder_with_config(
            ResolverConfig::from_parts(
                ...
                vec![],
                vec![
                    NameServerConfig::new(mdns_ipv4, ProtocolConfig::Mdns),
                    NameServerConfig::new(mdns_ipv6, ProtocolConfig::Mdns),
                ],
            ),
